...
bool operator==(const ::hps_camera::cameraRequest_<ContainerAllocator1> & lhs, const ::hps_camera::cameraRequest_<ContainerAllocator2> & rhs)
{
  return lhs.client_node_name == rhs.client_node_name;
}
