...
message(STATUS "hps_camera: 1 messages, 1 services")

set(MSG_I_FLAGS "-Ihps_camera:/home/ubuntu/catkin_ws3/src/hps_camera/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/ubuntu/catkin_ws3/src/hps_camera/msg/distance.msg" NAME_WE)
add_custom_target(_hps_camera_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hps_camera" "/home/ubuntu/catkin_ws3/src/hps_camera/msg/distance.msg" ""
)

get_filename_component(_filename "/home/ubuntu/catkin_ws3/src/hps_camera/srv/camera.srv" NAME_WE)
add_custom_target(_hps_camera_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hps_camera" "/home/ubuntu/catkin_ws3/src/hps_camera/srv/camera.srv" ""
)
...
_generate_msg_cpp(hps_camera
  "/home/ubuntu/catkin_ws3/src/hps_camera/msg/distance.msg"
  "${MSG_I_FLAGS}"
  ""
...
_generate_srv_cpp(hps_camera
  "/home/ubuntu/catkin_ws3/src/hps_camera/srv/camera.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/hps_camera
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/hps_camera)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/hps_camera\")")
  # install generated code
  install(
